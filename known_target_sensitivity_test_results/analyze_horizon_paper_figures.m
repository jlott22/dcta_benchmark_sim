...
outDir = fullfile(scriptDir, 'horizon_results', 'figs');
if ~exist(outDir, 'dir')
    mkdir(outDir);
end
...
scenarioSpecs = struct( ...
    ...
    'inputFile', { ...
        fullfile(repoRoot, 'known_target_sensitivity_test_results', 'horizon_results', 'combined', 'system_performance.csv'), ...
        fullfile(repoRoot, 'clue_sensitivity_test_results', 'horizon_results', 'combined', 'system_performance.csv'), ...
        fullfile(repoRoot, 'coverage_sensitivity_test_results', 'horizon_results', 'combined', 'system_performance.csv') ...
    }, ...
...
heatmapSpecs = struct( ...
    'name', {'Collaborative Visit', 'Bayesian Search', 'Coverage'}, ...
    'decisionFile', { ...
        fullfile(repoRoot, 'runs', 'autonomous_weekend_plan', 'known_horizon_tuning_decision.csv'), ...
        fullfile(repoRoot, 'runs', 'autonomous_weekend_plan', 'clue_horizon_tuning_decision.csv'), ...
        fullfile(repoRoot, 'runs', 'autonomous_weekend_plan', 'coverage_horizon_tuning_decision.csv') ...
    });
