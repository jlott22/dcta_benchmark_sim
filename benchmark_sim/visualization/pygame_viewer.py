...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--comm-model", default="ideal", choices=["ideal", "bernoulli", "gilbert_elliott", "gilbert_elliot", "rayleigh_style"])
    p.add_argument("--comm-level", type=float, default=None)
    p.add_argument("--max-trials", type=int, default=None)
    p.add_argument("--seed", type=int, default=0)
    p.add_argument("--out-dir", default="results/viewer")
